...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        self.toynet_ema = Weight_EMA_Update(cuda(ToyNet(self.K,self.dim_input,self.output_features),     self.cuda), self.toynet.state_dict(), decay=0.999)
    ...
    def train(self):
        ...
        for e in range(self.epoch):  ## each epoch
            ...
            for idx, (data,label) in enumerate(self.data_loader['train']):
                ...
                accum_accuracy+=correct/total_num
            ...
            avg_accuracy =  accum_accuracy/counter
